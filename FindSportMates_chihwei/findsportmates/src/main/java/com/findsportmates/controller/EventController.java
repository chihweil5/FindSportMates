...
public class EventController {
	...
	public List<Event> searchtEvent(ModelMap model,@RequestParam("type") String type,@RequestParam("date") String date,@RequestParam("time1") String num_L,@RequestParam("time2") String num_U) {
